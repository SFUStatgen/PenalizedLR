...
```
23 out of 50 coefficients are changed by more than 10\% when population is excluded. The distribution of estimated coefficients doesn't change a lot with or without population included in the model. I guess we should get a little bit smaller $m$ when we include the population, as suggested by Siyuan's method (see Table 3 and 4 on Overleaf document).
