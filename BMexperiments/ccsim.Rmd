...
rcase <- function(n,beta,MAF) {
  ...
  p2 <- MAF^2*exp(2*beta)
  pp <- c(p0,p1,p2)
  if(any(pp < 0)) print(c(MAF,beta,pp))
...
* Simulate covariates with MAF = 0.05 and fit singl-SNP models
...
plot(dat$beta,betahat) # betahats still attenuated, but less so 
